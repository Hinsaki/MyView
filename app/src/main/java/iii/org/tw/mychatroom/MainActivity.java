...
public class MainActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // 從資源檔裡取得位址後強制轉型成文字方塊
        TextView01 = (TextView) findViewById(R.id.TV1);
        EditText01=(EditText) findViewById(R.id.ET1);
        EditText02=(EditText) findViewById(R.id.ET2);
    ...
    private Runnable readData = new Runnable() {
        public void run() {
            ...
            try {
                ...
                serverIp = InetAddress.getByName("10.1.6.52");
                int serverPort = 5050;
